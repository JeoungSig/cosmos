...
<script type="text/javascript">
	function pageReload() {
	    document.location.href = '/cosmos/framework/sysproperty/Main.action';
	}
	function modifyBasicInfo() {
	    var url = '/cosmos/framework/sysproperty/BasicInfoModifyForm.action';
	    var windowName = 'framework/sysproperty/basicInfoModifyForm';
	    var win = openPopupForm(url, windowName, '700', '500'); 
	}
	function modifyAdmin() {
	    var url = '/cosmos/framework/sysproperty/AdministratorModifyForm.action';
	    var windowName = 'framework/sysproperty/administratorModifyForm';
	    var win = openPopupForm(url, windowName, '700', '500');
	}
	function modifyExceptionUrl() {
	    var url = '/cosmos/framework/sysproperty/AccessCheckExceptUrlModifyForm.action';
	    var windowName = 'framework/sysproperty/accessCheckExceptUrlModifyForm';
	    var win = openPopupForm(url, windowName, '700', '500');
	}
	function modifyDataUploadRootpath() {
	    var url = '/cosmos/framework/sysproperty/DataUploadRootPathModifyForm.action';
        ...
        <table id="detail_table" class="detail_table" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td class="value" colspan="3">
                    <img src="/cosmos/image?file=${fileDto.savedName}" width="90px" height="90px"/>
                </td>
            </tr>
