...
<script type="text/javascript">
    function setAddress(object){
        ...
        $.ajax({
            url : "/cosmos/common/common/PostalAddress.action",
...
<script type="text/javascript">
    ...
    function saveUser() {
        ...
        var url = "/cosmos/common/filecontrol/FileModify.action";
        if($('#pictureFile').val() != null && $('#pictureFile').val() != ''){
        	//이미 저장된 파일이 있는 경우
        	url = "/cosmos/common/filecontrol/FileModify.action";
        }else{
        	//수정을 하고있지만 신규로 사진을 등록해야하는 경우
        	url = "/cosmos/common/filecontrol/FileUpload.action";
        }
    ...
    function modifyDetailUserInfo() {
        ...
        $.ajax({
            url : "/cosmos/framework/usermanager/UserModify.action",
            data : {
                  userId      : userId      ,
                  userName    : userName    ,
                  passwd      : passwd      ,
    ...
    <div id="detail_panel" class="detail_panel">
        <table id="detail_table" class="detail_table" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td class="label" rowspan="3">Photo :</td>
                <td class="value" rowspan="3"> 
                    <div id="fileSaving" style="display: none;"><img src="/cosmos/resources/images/common/loding_re.gif" /><br/>Saving....</div>
                    <div id="fileField"  style="display: block;">
                        <c:choose>
                            <c:when test="${!empty userProfilePhoto}">
                                <img src="/cosmos/image?file=${userPhoto}" width="60px" height="60px"/>
                            </c:when>
                        </c:choose>                    
            ...
            <tr>
                ...
                <td class="value"><input type="input" id="passwd" name="passwd" style="width: 200px;" mandatory="true" value="<c:out value="${userDto.passwd}"/>" /></td>
            </tr>            
            <tr>
            ...
            <tr>
                <td class="label"><span class="required">*</span>Type :</td>
                <td class="value" colspan="3">
                    <select name="userType" id="userType" style="width: 150px"  mandatory="true"><c:out value="${userTypeOptions}" escapeXml="false"/></select>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="value" colspan="3">
                    <select name="addrSuburb" id="addrSuburb" style="width: 150px">
            ...
            <tr>
                ...
                <td class="value" colspan="3">
                    <select id="useYn" name="useYn" style="width: 100px" mandatory="true"/>
                            ...
                            <option value="Y" <c:if test="${userDto.useYn == 'Y' }"> selected </c:if>>Active</option>
                            <option value="N" <c:if test="${userDto.useYn == 'N' }"> selected </c:if>>Disable</option>
                    </select>
                </td>
            </tr>
        </table>
