...
<script type="text/javascript">
    ...
    function saveDetailUserInfo() {
        ...
        $.ajax({
            url : "/cosmos/framework/usermanager/UserRegist.action",
            data : {
            	  userId      : userId      ,
            	  userName    : userName    ,
            	  passwd      : passwd      ,
    ...
    function callbackSaveDetailUserInfo(data) {
        ...
        var returnValue = {
        		message : $('#userName').val() + "are added."
        };
...
<script type="text/javascript">
    function checkUserId(object){
    	...
    	if($('#userId').val() == null || $('#userId').val() == ''){
    		$('#userId').css('background-color: #fffacd');
    		pageLog("ID field is mandatory.", "warn");
    		return;
    	}

    	$.ajax({
            url : "/cosmos/framework/usermanager/ExistUserInfo.action",
    ...
    <div id="detail_panel" class="detail_panel">
        <table id="detail_table" class="detail_table" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td class="value"><input type="password" id="passwd" name="passwd" style="width: 200px;" mandatory="true"/></td>
            </tr>            
            <tr>
            ...
            <tr>
                ...
                <td class="value"><input id="birthDt" name="birthDt" style="width: 100px;" readonly="readonly"/></td>
    ...
    <div id="main_control" class="main_control">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td width="85%"></td>
                <td width="*" align="left">
                    <button class="word3" onclick="addUser();">add</button>
                </td>
            </tr>
        </table>
    </div>
