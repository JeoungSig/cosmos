...
<script type="text/javascript">
    ...
    function addUserInfo() {
        var url = '/cosmos/common/createAccount/AccountRegistForm.action';
...
<script type="text/javascript">
    function login(){
        ...
        $.ajax({
            url : "/cosmos/common/auth/Login.action",
            data : {
                userId : userId,
                passwd : passwd },  
    ...
    function callbackLogin(data) {
        ...
        if(data.status == 'success'){
            // 로그인이 성공적으로 이루어진경우
            document.location.href = "/cosmos/common/auth/Welcome.action";
        } else {
    ...
    <div class="detail_panel">
        <table cellpadding="0" cellspacing="0" class="detail_table" style="width: 550px;">
            <tr>
                ...
                <td style="width: 200px; vertical-align: bottom;" rowspan="2"><img src="/cosmos/resources/images/common/Login.jpg" style="width: 40%;cursor: pointer;" onclick="javascript:login();"></td>
            </tr>
            <tr>
