...
<body>
	...
	<table>
		<tr>
			<td><img src="/cosmos/resources/images/common/task.jpg" style="height: 40px;"></td>
			<td style="vertical-align: bottom;"><font size="5px"><b> MY TASK LIST </b></font></td>
		</tr>
	</table> 
	<hr />
	<table id="grid_table" class="grid_table" width="500px" cellspacing="0" cellpadding="0" bgcolor=#FFE8F3>
							...
							<tr>
								...
								<td>
									<c:forEach var="serviceInfo" items="${serviceList}" varStatus="cnt">
				                        ...
				                        <a href="javascript:go('/cosmos<c:out value="${serviceInfo.svcPrefix }" /><c:out value="${serviceInfo.svcUrl }" />/Main.action');"> <c:out value="${serviceInfo.svcName }" /></a>
