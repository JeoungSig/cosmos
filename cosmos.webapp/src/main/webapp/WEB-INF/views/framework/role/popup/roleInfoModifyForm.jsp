...
<script type="text/javascript">
	...
	function modifyRoleInfo() {
		...
		$.ajax({
			url : "/cosmos/framework/rolemanager/RoleModify.action",
			data : {
				roleId : roleId,
				roleName : roleName,
				roleDesc : roleDesc,
    ...
    function deleteRoleInfo() {
        ...
        $.ajax({
            url : "/cosmos/framework/rolemanager/RoleDelete.action",
            data : {
                roleId : roleId
            },
    ...
    function serviceMapping(roleId) {
        var url = '/cosmos/framework/rolemanager/RoleServiceMapping.action?roleId='+ roleId;
