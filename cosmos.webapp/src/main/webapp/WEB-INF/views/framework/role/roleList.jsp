...
<script type="text/javascript">
	function search() {
		...
		$.ajax({
			url : "/cosmos/framework/rolemanager/RoleList.action",
			data : {
				roleName : roleName
			},
...
<script type="text/javascript">
    function addRoleInfo() {
        var url = '/cosmos/framework/rolemanager/RoleRegistForm.action';
    ...
    function modifyRoleInfo(roleId) {
        var url = '/cosmos/framework/rolemanager/RoleModifyForm.action?roleId=' + roleId;
