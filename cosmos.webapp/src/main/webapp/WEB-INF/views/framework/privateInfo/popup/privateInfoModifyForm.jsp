...
<script type="text/javascript">
    ...
    function modifyDetailUserInfo() {
        ...
        $.ajax({
            url : "/cosmos/framework/privateInfo/PrivateInfoModify.action",
            data : {
                  userId      : userId      ,
                  userName    : userName    ,
                  passwd      : passwd      ,
    ...
    function callbackModifyDetailUserInfo(data) {
    	...
    	document.location.href='/cosmos/framework/privateInfo/PrivateDetailInfo.action?pupupMode=<c:out value="${pupupMode}"/>&userId=<c:out value="${userDto.userId}"/>';
    }
