...
<body>
	...
	<table id="grid_table" class="grid_table" style="width: 90%;" cellspacing="0" cellpadding="0" align="center" border="0"> 
		<tr>
			<td width="100px"><img src="/cosmos/resources/images/common/accessdenied.jpg" style="height: 120px;"></td> 
			<td>
			     <font color="#0063C6"><b>Restricted area, Authorised entry only</b></font>
			     <br/><br/>
			     <font color="#8B8B8B">
