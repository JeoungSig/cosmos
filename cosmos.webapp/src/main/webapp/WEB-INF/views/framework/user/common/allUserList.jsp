...
<script type="text/javascript">
	function search() {
		...
		$.ajax({
			url : "/cosmos/common/common/alluserlist/UserList.action",
			data : {
				firstName : firstName,
				userType : userType,
				roleId : roleId,
        ...
        if (dataCnt > 0) {
            ...
            $.each(json, function(i, obj) {
                 ...
                 if(obj.pictureFullPath == '' || obj.pictureFullPath == null){
                	   ...
                	   element[0] = '<img src="/cosmos/image?file=' + obj.pictureFullPath + '" width="50px" height="55px"/>';
                 }
    ...
    function setUserTypeAndRole() {
        $.ajax({
            url : "/cosmos/framework/usermanager/UserTypeAndRole.action",
...
<script type="text/javascript">
    function addUserInfo() {
        var url = '/cosmos/framework/usermanager/UserRegistForm.action';
    ...
    function modifyUserInfo(userId) {
        var url = '/cosmos/framework/usermanager/UserModifyForm.action?userId=' + userId;
        var windowName = 'sysAdmin/framework/UserModifyForm';
        var win = openPopupForm(url, windowName, '720', '540');
    }
    
    function getUserInfo(userId) {
        var url = '/cosmos/framework/usermanager/UserDetailInfo.action?userId=' + userId;
    ...
    function viewUserRoles(userId) {
        var url = '/cosmos/framework/usermanager/UserRole.action?userId=' + userId;
        var windowName = 'sysAdmin/framework/UserDetailInfo';
        var win = openPopupForm(url, windowName, '720', '540');
    }
