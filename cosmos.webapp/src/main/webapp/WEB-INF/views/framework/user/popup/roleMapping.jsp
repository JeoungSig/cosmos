...
<script type="text/javascript">
	...
	function search() {
		...
		$.ajax({
			url : "/cosmos/framework/usermanager/UserRoleMapping.action",
			data : {
				userId : userId,
				mapped : "N"
			},
...
<script type="text/javascript">
	...
	function mappingAdd() {
		...
		if (cnt == 0) {
			...
			$.ajax({
				url : "/cosmos/framework/usermanager/UserRoleMappingApply.action",
...
<script type="text/javascript">
    ...
    function mappingRemove() {
        ...
        if (cnt == 0) {
            ...
            $.ajax({
                url : "/cosmos/framework/usermanager/UserRoleMappingRemove.action",
                data : "jsonParam=" + jsonParam,
                success : callbackSave
            });
        }
