...
<script type="text/javascript">
	function search() {
		...
		$.ajax({
			url : "/cosmos/framework/servicemanager/ServiceList.action",
			data : {
				svcName : svcName,
				useYn : useYn,
				svcPrefix : svcPrefix,
...
<script type="text/javascript">
    function addServiceInfo() {
        var url = '/cosmos/framework/servicemanager/ServiceRegistForm.action';
    ...
    function modifyServiceInfo(svcId) {
        var url = '/cosmos/framework/servicemanager/ServiceModifyForm.action?svcId=' + svcId;
