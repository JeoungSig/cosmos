...
<link rel="stylesheet" type="text/css" href="/cosmos/resources/css/sys_admin.css" />
...
<body id="physical_body">
    <table style="width: 100%;" cellspacing="0" cellpadding="0" bgcolor="#1A1A1A" border="0">
        <tr>
            <td rowspan="3" width="70px"><img src="/cosmos/image?file=<c:out value="${logfile.fullPath }" />" style="height: 80px;cursor: pointer; " alt="Cosmos Framework Ver.1.0"  onclick="javascript:goHome();"/></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
