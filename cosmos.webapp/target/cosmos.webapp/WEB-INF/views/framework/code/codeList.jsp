...
<script type="text/javascript">
    ...
    function setSystemCombo() {
        $.ajax({
            url : "/cosmos/framework/codemanager/SystemCodeList.action",
    ...
    function changeCategory(systemCd) {
        $.ajax({
            url : "/cosmos/framework/codemanager/CategoryCodeList.action",
...
<script type="text/javascript">
    function addCodeInfo() {
        var url = '/cosmos/framework/codemanager/CodeRegistForm.action';
    ...
    function modifyCodeInfo(systemCd,categoryCd,codeValue) {
        var url = '/cosmos/framework/codemanager/CodeModifyForm.action?systemCd=' + systemCd + '&categoryCd=' + categoryCd + '&codeValue=' + codeValue;
    ...
    function deleteCodeInfo() {
        ...
        if(cnt == 0) {
            ...
            $.ajax({
                url : "/cosmos/framework/codemanager/CodeDelete.action",
...
<script type="text/javascript">
    function search() {
        ...
        $.ajax({
            url : "/cosmos/framework/codemanager/CodeList.action",
            data : {
                systemCd : systemCd,
