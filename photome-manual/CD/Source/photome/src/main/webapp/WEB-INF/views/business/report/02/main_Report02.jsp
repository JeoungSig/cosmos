     ...
     var element = null;
      ...
      if (dataCnt > 0) {
          ...
          $.each(json, function(i, obj) {
              element = new Array();
               ...
               element[0] = '<a style=\"text-decoration:none;\" href=\"javascript:viewBoothInfo(\''+ obj.boothGroupDto.groupName + '\')\"><b>' + obj.boothGroupDto.groupName + '</b></a>';
               ...
               element[8] = decode(obj.rateOfReturnQ1, '0.00','',obj.rateOfReturnQ1);
               element[9] = decode(obj.collectAmtQ1, '0.00','',obj.collectAmtQ1);
               element[10] = decode(obj.rentFeeAmtQ1, '0.00','',obj.rentFeeAmtQ1);
               element[11] = decode(obj.refundAmtQ1, '0.00','',obj.refundAmtQ1);
               ...
               element[15] = decode(obj.rateOfReturnQ2, '0.00','',obj.rateOfReturnQ2);
               element[16] = decode(obj.collectAmtQ2, '0.00','',obj.collectAmtQ2);
               element[17] = decode(obj.rentFeeAmtQ2, '0.00','',obj.rentFeeAmtQ2);
               element[18] = decode(obj.refundAmtQ2, '0.00','', obj.refundAmtQ2);
               ...
               element[22] = decode(obj.rateOfReturnQ3, '0.00','',obj.rateOfReturnQ3);
               element[23] = decode(obj.collectAmtQ3, '0.00','',obj.collectAmtQ3);
               element[24] = decode(obj.rentFeeAmtQ3, '0.00','',obj.rentFeeAmtQ3);
               element[25] = decode(obj.refundAmtQ3, '0.00','',obj.refundAmtQ3);
               ...
               element[29] = decode(obj.rateOfReturnQ4, '0.00','',obj.rateOfReturnQ4);
               element[30] = decode(obj.collectAmtQ4, '0.00','',obj.collectAmtQ4);
               element[31] = decode(obj.rentFeeAmtQ4, '0.00','',obj.rentFeeAmtQ4);
               element[32] = decode(obj.refundAmtQ4, '0.00','',obj.refundAmtQ4);
      ...
      obj.colModel = [
                      ...
                      {title:'<b><div style=\"text-align: center;\">Total ($)</div></b>', colModel: [
                                                                    ...
                                                                    {title:"<b>Collect</b>",dataIndx: 2, width:90, dataType:"integer",align: "right",
                                                                        render: function (ui) {
                                                                            var rowData = ui.rowData;
                                                                              return '<font color="#CC0000"><b>' + rowData[2] + '</b></font>';
                                                                      }                                                                         
                                                                    },
                                                                    {title:"<b>RentFee</b>",dataIndx: 3, width:90, dataType:"integer",align: "right",
                                                                        render: function (ui) {
                                                                            var rowData = ui.rowData;
                                                                              return '<font color="#CC0000">' + rowData[3] + '</font>';
                                                                      }                                                                             
                                                                    }, 
                                                                    {title:"<b>Refund</b>",dataIndx: 4, width:90, dataType:"integer",align: "right",
                                                                        render: function (ui) {
                                                                            var rowData = ui.rowData;
                      ...
                      {title:'<b><div style=\"text-align: center;\">3/4 Quater</div></b>', colModel: [
                                                                    ...
                                                                    {title:"<b>Refund</b>",dataIndx: 25, width:60, dataType:"integer",align: "right",
                                                                                render: function (ui) {
                                                                                    var rowData = ui.rowData;
                                                                                      return '<font color="#0076EC">' + rowData[25] + '</font>';
                                                                              }                                                                                     
                                                                    }
                                                                    ]},
