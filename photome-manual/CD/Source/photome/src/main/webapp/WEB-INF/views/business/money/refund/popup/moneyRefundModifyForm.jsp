...
<script type="text/javascript">
    function save() {
        ...
        if(boothName == null) boothId = null;
        
        $.ajax({
            url : "/photome/business/money/refund/MoneyRefundModify.action",
            data : {
            	refundId        : refundId ,
                boothId        : boothId ,
                reqDt          : reqDt   ,
            ...
            <table id="detail_table" class="detail_table" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td class="value" colspan="3">
                        <input type="text" id="boothName" name="boothName" style="width: 350px; background-color: #E5E5E5;" readonly="readonly" value="<c:out value="${refundDto.boothName }" />" />
                        <input type="hidden" id="boothId" name="boothId" value="<c:out value="${refundDto.boothId }" />"/>                    
                ...
                <tr>
                    ...
                    <td class="value" colspan="3"><input id="reqDt" name="reqDt" style="width: 150px;background-color: #E5E5E5;" readonly="readonly"  mandatory="true" value="<c:out value="${refundDto.reqDt }" />" /></td>
                </tr>
                <tr style="height: 15px;"><td colspan="4"></td></tr>
                                
                <tr>
                    <td class="label"><span class="required">*</span>First Name :</td>
                    <td class="value"><input type="text" id="reqFirstname" name="reqFirstname" style="width: 150px;"  maxlength="25"  mandatory="true"  value="<c:out value="${refundDto.reqFirstname }" />" /></td>
                    <td class="label">Last Name :</td>
                    <td class="value"><input type="text" id="reqLastname" name="reqLastname" style="width: 150px;" maxlength="25" value="<c:out value="${refundDto.reqLastname }" />" /></td>
                    
                </tr>
                <tr>
                    <td class="label">Contact info. :</td>
                    <td class="value" colspan="3"><input type="text" id="reqContactInfo" name="reqContactInfo" style="width: 380px;" value="<c:out value="${refundDto.reqContactInfo }" />" /></td>
                </tr>
                <tr style="height: 15px;"><td colspan="4"></td></tr>
                ...
                <tr>
                    ...
                    <td class="value">
                        <input type="text" id="reqPostcd" name="reqPostcd" style="width: 100px;;background-color: #DFEFFF;" onblur="setAddress(this);"  value="<c:out value="${refundDto.reqPostcd }" />" />
                    ...
                    <td class="value"><input type="text" id="reqState" name="reqState" style="width: 150px; background-color: #E5E5E5;" readonly="readonly" value="<c:out value="${refundDto.reqState }" />" /></td>
                </tr>
                <tr>
                    <td class="label">No/Street :</td>
                    <td class="value" colspan="3"><input type="text" id="reqStreetNo" name="reqStreetNo" style="width: 380px;" value="<c:out value="${refundDto.reqStreetNo }" />" /></td>
                </tr>
                <tr>
                    <td class="label">Suburb :</td>
                    <td class="value" colspan="3">
                        <select name="reqSuburb" id="reqSuburb" style="width: 150px" >
                ...
                <tr>
                    ...
                    <td class="value"><input id="refundDt" name="refundDt" style="width: 150px;background-color: #E5E5E5;" readonly="readonly" value="<c:out value="${refundDto.refundDt }" />" /></td>
                </tr>
                                
                <tr>
                    <td class="label">Refund Amount :</td>
                    <td class="value" colspan="3"><input type="text" id="refundAmount" name="refundAmount" style="width: 200px;"  value="<c:out value="${refundDto.refundAmount }" />" /></td>
                </tr>                
                <tr>
                    <td class="label"><span class="required">*</span>Reason :</td> 
                    <td class="value" colspan="3"><input id="refundReason" name="refundReason" style="width: 500px;" maxlength="300" mandatory="true" value="<c:out value="${refundDto.refundReason }" />"/></td>
                </tr>
                <tr style="height: 15px;"><td colspan="4"></td></tr>
    ...
    <div id="main_control" class="main_control">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td width="75%"></td>
                <td width="*" align="left">
                    <button class="word3" onclick="save()">modify</button>
                </td>
            </tr>
        </table>
    </div>
