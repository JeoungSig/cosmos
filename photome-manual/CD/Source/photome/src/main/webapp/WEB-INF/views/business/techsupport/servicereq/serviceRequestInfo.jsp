...
<script type="text/javascript">
    ...
    function deleteSvcReq(historyId){
        $.ajax({
            url : "/photome/business/techsupport/servicereq/ServiceRequestDelete.action",
            data : {
            	historyId : historyId
            },
			...
			<tr>
				<td align="right">
				    <c:if test="${sessionUserId == 'admin' || sessionUserId == historyDto.creator}" >
					    ...
					    <button class="word3" onclick="deleteSvcReq('<c:out value="${historyDto.historyId }" />');">delete</button>
