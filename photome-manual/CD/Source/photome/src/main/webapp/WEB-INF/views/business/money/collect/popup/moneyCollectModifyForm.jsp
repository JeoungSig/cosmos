...
<script type="text/javascript">
    function save() {
        ...
        if('<c:out value="${checkCoinMeter}" />' == 'CHECK'){
	        if(parseInt(coinMtrNow) <= parseInt(beforeCoinMtr)){
...
<script type="text/javascript">
    function getBoothStatus(obj){
        var boothId = obj.value;
        if(boothId == '' || boothId == null) {
            return;
        }
        $.ajax({
            url : "/photome/business/money/collect/BoothInfo.action",
            data : "boothId=" + boothId,
            success : callbackGetBoothStatus
        });     
    }     
    function callbackGetBoothStatus(data) {
        var status = data.boothDto.status;
		...
		<div id="detail_panel" class="detail_panel">
			<table id="detail_table" class="detail_table" cellpadding="0" cellspacing="0">
	            ...
	            <tr>
	                ...
	                <td><select name="groupId" id="groupId" style="width: 150px" onChange="setBooth(this)"  mandatory="true" disabled="disabled"><c:out value="${groupListOptions}" escapeXml="false" /></select></td>
	            ...
	            <tr>
	                ...
	                <td colspan="3"><select name="boothId" id="boothId" style="width: 350px" onChange="getBeforeValues(this);getBoothStatus(this)"  mandatory="true" disabled="disabled"><c:out value="${boothListOptions}" escapeXml="false" /></select></td>
	            </tr>
                <tr>
	            ...
	            <tr>
                    ...
                    <td class="label"><span class="required">*</span>Printed cash record :</td>
