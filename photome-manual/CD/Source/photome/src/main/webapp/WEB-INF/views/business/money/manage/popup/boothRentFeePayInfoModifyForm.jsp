...
<script type="text/javascript">
    function modify() {
        ...
        if(groupId == "ALL") {
            alert("Group can not be 'ALL'\nPlease, select other element.");
            return;
        }
        ...
        $.ajax({
            url : "/photome/business/money/manage/boothrentfeepay/BoothRentFeePayModify.action",
            data : {
            	groupId      : groupId ,
            	year         : year    ,
            	month        : month   ,
    ...
    function callbackSave(data) {
    	pageLog("New collect information modified");
		...
		<div id="detail_panel" class="detail_panel">
			<table id="detail_table" class="detail_table" cellpadding="0" cellspacing="0">
	            ...
	            <tr>
	                ...
	                <td>&nbsp;
	                    <select name="year" id="year" style="width: 100px" mandatory="true"><c:out value="${yearOptions}" escapeXml="false"/></select>
	                    <select name="month" id="month" style="width: 100px" mandatory="true"><c:out value="${monthOptions}" escapeXml="false"/></select>
	                </td>
	            </tr>
	            <tr>
                ...
                <tr>
                    ...
                    <td class="value"><input id="rentFee" name="rentFee" style="width: 200px;"  mandatory="true" value="<c:out value="${boothRentFeePayDto.rentFee}"/>"/></td>
                ...
                <tr>
                    ...
                    <td class="value" colspan="3"><input id="rentComment" name="rentComment" style="width: 490px;" value="<c:out value="${boothRentFeePayDto.rentComment}"/>" /></td>
                </tr> 
			</table>
		</div>
	</form>
