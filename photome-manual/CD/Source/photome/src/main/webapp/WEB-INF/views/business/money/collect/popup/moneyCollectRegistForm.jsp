		...
		<div id="detail_panel" class="detail_panel">
			<table id="detail_table" class="detail_table" cellpadding="0" cellspacing="0"> 
	            ...
	            <tr>
	                ...
	                <td colspan="3"><select name="boothId" id="boothId" style="width: 350px" onChange="getBeforeValues(this);getBoothStatus(this)"  mandatory="true" ></select></td>
	            </tr>
	            <tr>
	            ...
	            <tr>
	                ...
	                <td class="value" colspan="3"><input id="coinMtrNow" name="coinMtrNow" style="width: 150px;"  onblur="checkCoinValue(this)" mandatory="true" /> &nbsp;&nbsp; <font color="#868686">Before : </font><font id="beforeCoinMtr" color="#868686">0</font></td> 
	            </tr>            
	            <tr>
