		...
		<div id="detail_panel" class="detail_panel">
			<table id="detail_table" class="detail_table" cellpadding="0" cellspacing="0" >
				...
				<tr>
                    ...
                    <td class="value" colspan="3"><select name="groupId" id="groupId" style="width: 170px" onChange="setBooth(this)"  mandatory="true"><c:out value="${groupListOptions}" escapeXml="false"/></select></td>
                </tr>    
				<tr>
					<td class="label"><span class="required">*</span>Booth :</td>
					<td class="value" colspan="3"><select name="boothId" id="boothId" style="width: 250px" mandatory="true"></select></td>
				</tr>
                ...
                <tr>
                    ...
                    <td class="value" colspan="3"><br /> &nbsp;<textarea name="contents" id="contents" rows="10" cols="2" style="width: 550px; height: 80px;"  mandatory="true"><c:out value="${historyDto.contents}"/></textarea> <br /> <br /></td>
                </tr>
