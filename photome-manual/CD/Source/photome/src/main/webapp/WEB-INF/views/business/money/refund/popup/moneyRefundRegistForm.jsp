            ...
            <table id="detail_table" class="detail_table" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td class="value" colspan="3">
                        <input type="text" id="boothName" name="boothName" style="width: 350px; background-color: #E5E5E5;" readonly="readonly" />
                ...
                <tr>
                    ...
                    <td class="value"><input id="reqDt" name="reqDt" style="width: 150px;background-color: #E5E5E5;" readonly="readonly"  mandatory="true" /></td>
                    <td class="label">Create Date</td>
                    <td class="value"><c:out value="${createDate }" /></td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="value"><input type="text" id="reqLastname" name="reqLastname" style="width: 150px;" maxlength="25" /></td>
                    
                </tr>
                <tr>
                    <td class="label">Contact info.</td>
                    <td class="value" colspan="3"><input type="text" id="reqContactInfo" name="reqContactInfo" style="width: 380px;"/></td>
                </tr>
                <tr style="height: 15px;"><td colspan="4"></td></tr>
                ...
                <tr>
                    ...
                    <td class="value">
                        <input type="text" id="reqPostcd" name="reqPostcd" style="width: 100px;;background-color: #DFEFFF;" onblur="setAddress(this);" />
                    ...
                    <td class="value"><input type="text" id="reqState" name="reqState" style="width: 150px; background-color: #E5E5E5;" readonly="readonly" /></td>
                </tr>
                <tr>
                    <td class="label">No/Street</td>
                    <td class="value" colspan="3"><input type="text" id="reqStreetNo" name="reqStreetNo" style="width: 380px;"/></td>
                </tr>
                <tr>
                    <td class="label">Suburb</td>
                    <td class="value" colspan="3"><select name="reqSuburb" id="reqSuburb" style="width: 150px;"></select></td>
                </tr>
                <tr style="height: 15px;"><td colspan="4"></td></tr>
