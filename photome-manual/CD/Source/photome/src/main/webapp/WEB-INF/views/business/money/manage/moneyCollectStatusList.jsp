...
<script type="text/javascript">
    ...
    function excelDown(){
        ...
        document.location.href="/photome/business/money/manage/MoneyCollectListForExcel.action?groupId="+ decode(groupId,'') + "&boothId=" + decode(boothId,'') + "&collectStatus=" + decode(collectStatus,'') + "&collectMonth=" + decode(collectMonth,'') + "&collectCollector=" + decode(collectCollector,'') + "&collectYear=" + decode(collectYear,'');
    ...
    function callbackSearch(data) {
        ...
        function calculateSummary() {
            ...
            bankAmtTotal  =  emptyDefaultValue(bankAmtTotal  , '0');
            ...
            footerSummary = ["<b>Total</b>",
                             ...
                             "<font color='#0000FF'><b><div id=\"bankAmtTotal\" style=\"text-align: right;\">$ " + addCommas(centRound(bankAmtTotal)) + "</div></b></font>",
                             "",
                             "",
                             "","","","","","","","",""];   
       ...
       setTotalValue('collectAmtTotal', '$ ' + addCommas(centRound(collectAmtTotal)));
       setTotalValue('bankAmtTotal', '$ ' + addCommas(centRound(bankAmtTotal)));
    }
        ...
        <table class="search_table" style="width: 1100px;" border="0"> 
            <tr>
                ...
                <td rowspan="2" style="text-align: right;vertical-align: bottom;">
                    <button class="search" onclick="retriveTableData();">Find</button>
                    <button class="excel_export" onclick="excelDown();">Excel export</button>
                </td>
            </tr>
            <tr>
