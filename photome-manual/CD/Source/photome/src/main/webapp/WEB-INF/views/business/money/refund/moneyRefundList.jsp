...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(function() {
            ...
            $("#fromCreateDt").datepicker(option);
            $("#toCreateDt").datepicker(option);
        });
...
<script type="text/javascript"> 
    ...
    function setDate() {
        ...
        $('#toCreateDt').val(tDate + '/' + tMonth + '/' + tYear);
        
        $('#fromReqDt').val(tDate + '/' + tMonth + '/' + tYear); 
        $('#fromCreateDt').val(tDate + '/' + tMonth + '/' + tYear);
        ...
        $('#fromCreateDt').val(fDate + '/' + fMonth + '/' + fYear);
        */
    }
...
<script type="text/javascript">
    ...
    function search() {
        ...
        var fromCreateDt = $('#fromCreateDt').val();
        var toCreateDt   = $('#toCreateDt').val();
        ...
        $.ajax({
            ...
            data : {
                ...
                fromReqDt  : fromReqDt,
                toReqDt  : toReqDt,
                fromCreateDt  : fromCreateDt,
                toCreateDt  : toCreateDt,
                reqState  : reqState,
    ...
    function callbackSearch(data) {
        ...
        if (dataCnt > 0) {
            ...
            $.each(json, function(i, obj) {
                ...
                element[11] = obj.createDt;
                element[12] = obj.refundReason;
                element[13] = obj.refundStatus;
                element[14] = obj.refundId;
                arrayData[i] = element; 
            });
        }
        ...
        obj.height = "70%";
        obj.colModel = [
            {title:'<b>Request Dt</b>', width:100, dataType:"string"},
            {title:"<b>Status</b>", width:100, dataType:"string",
                render: function (ui) {
                    var rowData = ui.rowData;
                    if (rowData[13] == 'ACCEPT') {
                      return '<font color="#E60073">' + rowData[1] + '</font>';
                    } else if (rowData[13] == 'REFUND') {
            ...
            {title:"<b>Group</b>", width:100, dataType:"string"},
            {title:"<b>Booth</b>", width:150, dataType:"string"},
            {title:"<b>Refund($)</b>", width:80, dataType:"integer", align: "right",
                render: function (ui) {
                    var rowData = ui.rowData;
                    return '<font color="#F9007C"><b>' + addCommas(rowData[4]) + '</b></font>';
              }             	
            	},
            {title:"<b>Refund Dt</b>", width:80, dataType:"string",align: "center"},
            {title:"<b>Last Name</b>", width:100, dataType:"string"},
            {title:"<b>First Name</b>", width:100, dataType:"string"},
            {title:"<b>Address</b>", width:190, dataType:"string"},
            {title:"<b>Suburb</b>", width:150, dataType:"string"},
            {title:"<b>State/P.C</b>", width:100, dataType:"string"},
            {title:"<b>Create Dt</b>", width:100, dataType:"string"},
            {title:"<b>Reason</b>", width:300, dataType:"string"},
        ...
        obj.rowClick = function( event, ui ) {
            ...
            var refundId = rowData.data[ui.rowIndx][14];
...
<body>
    ...
    <div id="search" style="width: 95%">
        <table class="search_table">
            ...
            <tr>
                <td class="label">Req. Dt</td> 
                <td><input id="fromReqDt" name="fromReqDt" style="width: 100px;background-color: #E5E5E5;" readonly="readonly"  mandatory="true" /> ~ <input id="toReqDt" name="toReqDt" style="width: 100px;background-color: #E5E5E5;" readonly="readonly"  mandatory="true" /></td>
                <td class="label">Create Dt</td> 
                <td><input id="fromCreateDt" name="fromCreateDt" style="width: 100px;background-color: #E5E5E5;" readonly="readonly"  mandatory="true" /> ~ <input id="toCreateDt" name="toCreateDt" style="width: 100px;background-color: #E5E5E5;" readonly="readonly"  mandatory="true" /></td>
                <td class="label">State </td>
                <td><select name="reqState" id="reqState" style="width: 150px" ><c:out value="${stateListOptions}" escapeXml="false" /></select></td>
                <td class="label">Use Y/N </td>
                <td><select name="useYn" id="useYn" style="width: 100px"><option value='' selected>All</option><option value='Y'>Active</option><option value='N'>Disabled</option></select></td>
