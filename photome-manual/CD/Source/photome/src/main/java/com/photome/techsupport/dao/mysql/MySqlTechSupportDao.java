...
public class MySqlTechSupportDao extends CosmosBaseDao implements TechSupportDao {
	...
	@Override
	public Integer deleteHistory(String historyId) throws Exception {
		return getSqlSession().delete("mySqlTechSupportDao.deleteHistory", historyId);
	}
	...
	@Override
	public List<UserDto> getServiceRequesterList(HashMap<String, String> param) throws Exception {
		return getSqlSession().selectList("mySqlTechSupportDao.getServiceRequesterList", param);
