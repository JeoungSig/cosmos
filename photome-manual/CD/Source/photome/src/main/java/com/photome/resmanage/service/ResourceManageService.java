...
public class ResourceManageService implements ResourceManage {
	...
	public String getGroupComboOptions(String selectedValue) throws Exception {
		...
		if (StringUtils.equalsIgnoreCase(selectedValue, "ALL")) {
			groupOptions.append("<option value=\"ALL\" selected>- ALL -</option>");
		} else {
			groupOptions.append("<option value=\"ALL\">- ALL -</option>");
		}
