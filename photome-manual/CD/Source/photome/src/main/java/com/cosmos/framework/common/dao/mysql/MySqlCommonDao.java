...
public class MySqlCommonDao extends CosmosBaseDao implements CommonDao {
	...
	public List<Map> selectCommonSQL(String sql) throws Exception {
		HashMap<String, Object> map = new HashMap<String, Object>();
		map.put("sql", sql);
		return getSqlSession().selectList("mySqlCommonDao.selectCommonSQL", map);
	}

	@Override
	public Integer updateCommonSQL(String sql) throws Exception {
		return getSqlSession().update("mySqlCommonDao.updateCommonSQL", sql);
	}

	@Override
	public Integer deleteCommonSQL(String sql) throws Exception {
		return getSqlSession().update("mySqlCommonDao.deleteCommonSQL", sql);
	}
