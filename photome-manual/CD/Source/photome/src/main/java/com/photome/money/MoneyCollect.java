/**
 * 2013 MoneyCollect.java Licensed to Steven J.S Min. For use this source code, you must have to get right from the author. Unless enforcement is
...
public interface MoneyCollect {
	 ...
	 * @throws Exception
	 */
	public Integer modifyCollectStatus(String collectId, String collectStatus, String userId) throws Exception;
	...
	/**
	 * 수금시 이전 코인미터정보를 체크하는지 검사한다.(기본값은 true)
	 * 
	 * @return
	 * @throws Exception
	 */
	public boolean checkBeforCoinMeter() throws Exception;
