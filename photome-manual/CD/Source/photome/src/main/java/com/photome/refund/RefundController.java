...
public class RefundController {
	...
	public Map<String, Object> refundList(HttpServletRequest request) throws Exception {
		...
		String fromCreateDt = request.getParameter("fromCreateDt");
		String toCreateDt = request.getParameter("toCreateDt");
		...
		if (StringUtils.isNotBlank(fromCreateDt)) param.put("fromCreateDt", fromCreateDt);
		if (StringUtils.isNotBlank(toCreateDt)) param.put("toCreateDt", toCreateDt);
	...
	public Map<String, Object> getBoothListOfGroup(HttpServletRequest request) throws Exception {
		...
		if (StringUtils.isNotBlank(groupId) && !StringUtils.equals(groupId, "ALL")) param.put("groupId", groupId);
	...
	public ModelAndView moneyRefundRegistForm(HttpServletRequest request) throws Exception {
		...
		mav.addObject("createDate", now.get(Calendar.YEAR) + "-" + (now.get(Calendar.MONTH) + 1) + "-" + now.get(Calendar.DATE));
		mav.addObject("refundStatusListOptions", code.getOptionsForHTML("PHOTOME", "REFUND_STATUS"));
