...
<script type="text/javascript">
    function modify(collectId) {
    	document.location.href = "/photome/business/money/collect/MoneyCollectModifyForm.action?collectId=" + collectId;
    }
    function viewCollectInfo(collectId) {
    	document.location.href = '/photome/business/money/collect/MoneyCollectInfo.action?collectId=' + collectId;
    }
</script>
<script type="text/javascript">
...
<body>
	...
	<div id="detail_panel" class="detail_panel">
		<table id="detail_table" class="detail_table" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td class="label">Film meter :</td>
                <td class="value"><p id="filmMtrNow"/></td>
			...
			<tr>
				...
				<td class="value" nowrap colspan="3"><c:out value="${moneyCollectDto.bankAccountName }" /></td>
			</tr>
			<tr>
				...
				<td colspan="4" style="width: 170px;">
					<table id="tbl_onsitepay" style="display: none; width: 100%;">
						...
						<tr>
							...
							<td class="value"><p id="onsitePayAmount" /></td>
						</tr>
						<tr style="height: 10px;">
							<td colspan="4">&nbsp;</td>
						</tr>
	...
	<div id="main_control" class="main_control">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td width="75%"> &nbsp;</td>
				<td align="left">
				    <c:if test="${ (moneyCollectDto.collectCollector == sessionUser.userId &&  moneyCollectDto.collectStatus == 'COLLECTING') || sessionUser.userId == 'admin' }">
					     <button class="word3" onclick="modify('<c:out value="${moneyCollectDto.collectId }" />')">modify</button>
