...
<script type="text/javascript">
    function save(SAVE_DIV) {
        ...
        var collectStatus = "COLLECT_FINISH";
        if(SAVE_DIV == 'SUBMIT'){
		...
		<div id="detail_panel" class="detail_panel">
			<table id="detail_table" class="detail_table" cellpadding="0" cellspacing="0">
	            ...
	            <tr>
	                ...
	                <td class="value"><input id=filmMtrNow name="filmMtrNow" style="width: 200px;"  mandatory="true"  value="<c:out value="${moneyCollectDto.filmMtrNow }" />"  /></td>
	                <td class="label"><span class="required">*</span>Coin meter :</td>
	                <td class="value"><input id="coinMtrNow" name="coinMtrNow" style="width: 150px;"  mandatory="true"  value="<c:out value="${moneyCollectDto.coinMtrNow }" />"  /></td>
	            </tr>            
	            <tr>
	            </tr>            
	            <tr>
                ...
                <tr>
                    ...
                    <td class="value" nowrap colspan="3">
                        <input type="text" id="bankAccountDisplayName" name="bankAccountDisplayName" style="width: 350px; background-color: #E5E5E5;" readonly="readonly" value="<c:out value="${moneyCollectDto.bankAccountName }" />" />
                        <input type="hidden" id="bankAccount" name="bankAccount" value="<c:out value="${moneyCollectDto.bankAccount }" />"  />
                ...
                <tr>
                    ...
                    <td class="value"><input type="text" id="bankAmount" name="bankAmount" style="width: 150px;" value="<c:out value="${moneyCollectDto.bankAmount }" />" />  </td>
                    <td class="label">Deposit Date :</td>
                    <td class="value"><input id="bankDt" name="bankDt" style="width: 150px;background-color: #E5E5E5;" readonly="readonly" value="<c:out value="${moneyCollectDto.bankDt }" />" /></td>
                </tr>
