     ...
     $('#grid_array').html(table_template);
      ...
      if (dataCnt > 0) {
          ...
          $.each(list, function(i, obj) {
               element = new Array();
               element[0] = ('<a href=\"javascript:viewBoothInfo(\''+ obj.boothDto.boothId + '\')\">' + obj.boothDto.boothName + '</a>');
      ...
      $('#table_data').dataTable( {
                 ...
                 "fnFooterCallback": function ( nRow, aaData, iStart, iEnd, aiDisplay ) {
                     ...
                     for ( var i=0 ; i<aaData.length ; i++ )
                     {
                    	 ...
                    	 if(contractUnit == 'BOOTH') iRentFeeAmtTot   += aaData[i][35]*1;
                     ...
                     if(contractUnit == 'BOOTH'){
                         nCells[3].innerHTML    =  toCurrency(iRentFeeAmtTot)  ;  
                     } else if(contractUnit == 'GROUP'){
                         nCells[3].innerHTML    =  toCurrency(groupRentFeeAmtTot)  ;  
                     }
